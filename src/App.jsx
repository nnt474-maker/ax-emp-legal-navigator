    ...
    <div className="app-shell">
      <aside className="sidebar sidebar--left">
        <div className="brand-block">
          ...
          <h1 className="brand-block__title">AX-EMP · Bản đồ quan hệ lao động</h1>
          <p className="brand-block__desc">
            Tra nhanh bên liên quan, căn cứ pháp lý, hồ sơ, quy trình và sự kiện trong nhóm quan hệ lao động.
          </p>
        </div>
        ...
        <section className="panel-card panel-card--muted">
          ...
          <ul className="help-list">
            <li>Chọn một ô trên sơ đồ để xem mô tả ngắn và các mục liên quan trực tiếp.</li>
            <li>Bật chế độ ẩn mục không liên quan để thu gọn sơ đồ theo nội dung đang xem.</li>
            <li>Dùng ô tìm kiếm để lọc nhanh theo mã, tên hồ sơ, quy trình hoặc căn cứ pháp lý.</li>
          </ul>
        </section>
      ...
      <main className="canvas-shell">
        ...
        <div className="canvas-shell__hint">
          <strong>Mẹo:</strong> chọn một Luật, Tài liệu hoặc Quy trình để chỉ xem nhóm nội dung liên quan. Khi cần quay lại toàn cảnh, chọn <strong>Hiện toàn bộ sơ đồ</strong>.
        </div>
      </main>
        ...
        <div className="details-header">
          ...
          <p className="details-header__subtitle">
            {selectedNode
              ...
              : "Chọn một ô trong sơ đồ để xem mô tả ngắn, liên kết trực tiếp và chuyển nhanh sang nội dung liên quan."}
          </p>
        </div>
        ...
        {selectedNode ? (
          <div className="details-stack">
            <section className="detail-card">
              ...
              <div className="detail-copy">
                {selectedNode.note ||
                  "Mục này đang được hiển thị trong bản đồ quan hệ lao động để hỗ trợ tra cứu nhanh."}
              </div>
          ...
          <div className="empty-state">
            ...
            <ul className="help-list">
              ...
              <li>Chọn một Tài liệu để xem căn cứ pháp lý, quy trình và sự kiện đi kèm.</li>
              <li>Dùng chế độ thu gọn để chuyển từ sơ đồ tổng quan sang nhóm nội dung đang cần tra cứu.</li>
            </ul>
          </div>
        )}
      </aside>
